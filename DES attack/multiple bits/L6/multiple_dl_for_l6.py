...
def obtain_probability_expression():
    ...
    P=Pl[:,31-7]^Pl[:,31-18]^Pl[:,31-24]
    C=Ch[:,31-7]^Ch[:,31-18]^Ch[:,31-24]^Ch[:,31-29]^Cl[:,31-15]
    K=subkey[1][:,47-22]^subkey[2][:,47-44]^subkey[3][:,47-22]^subkey[5][:,47-22]
...
def make_train_data(n,num_pair):
    ...
    for i in range(num_pair):
        ...
        cipher_X.append(Pl[:,31-7]^Pl[:,31-18]^Pl[:,31-24]^Ch[:,31-7]^Ch[:,31-18]^Ch[:,31-24]^Ch[:,31-29]^Cl[:,31-15]^subkey[1][:,47-22]^subkey[2][:,47-44]^subkey[3][:,47-22]^subkey[5][:,47-22])
