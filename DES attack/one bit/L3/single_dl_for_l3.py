...
def obtain_probability_expression():
    ...
    #
    keys = np.frombuffer(urandom(64*num), dtype=np.uint8).reshape(-1,64)
    keys = keys & 1
    ...
    P=Ph[:,31-7]^Ph[:,31-18]^Ph[:,31-24]^Ph[:,31-29]^Pl[:,31-15]
    C=Ch[:,31-7]^Ch[:,31-18]^Ch[:,31-24]^Ch[:,31-29]^Cl[:,31-15]
    K=subkey[0][:,47-22]^subkey[2][:,47-22]
...
#a=obtain_probability_expression()
...
def make_train_data(n,num_pair):
    ...
    for i in range(num_pair):
        ...
        cipher_X.append(Ph[:,31-7]^Ph[:,31-18]^Ph[:,31-24]^Ph[:,31-29]^Pl[:,31-15]^Ch[:,31-7]^Ch[:,31-18]^Ch[:,31-24]^Ch[:,31-29]^Cl[:,31-15]^subkey[0][:,47-22]^subkey[2][:,47-22])
