...
def make_train_data(n,num_pair):
    ...
    for i in range(num_pair):
        ...
        cipher_X.append(Ph[:,31-15]^Pl[:,31-7]^Pl[:,31-18]^Pl[:,31-24]^Pl[:,31-27]^Pl[:,31-28]^Pl[:,31-29]^Pl[:,31-30]^Pl[:,31-31]^Ch[:,31-15]^Cl[:,31-7]^Cl[:,31-18]^Cl[:,31-24]^Cl[:,31-27]^Cl[:,31-28]^Cl[:,31-29]^Cl[:,31-30]^Cl[:,31-31]^subkey[0][:,47-42]^subkey[0][:,47-43]^subkey[0][:,47-45]^subkey[0][:,47-46]^subkey[1][:,47-22]^subkey[3][:,47-22]^subkey[4][:,47-42]^subkey[4][:,47-43]^subkey[4][:,47-45]^subkey[4][:,47-46])
...
def train_model(num_pair):
    net_name='./neural_network/single_L_'+str(get_Round())+'_'+str(num_pair)+'v2'
...
Num_pair=[16,20,22,24,26,28,30,32,34,52,60,70,80,90,100,110,120,130,140]
