...
def attack_5_round_use_L5(num_pair):
    ...
    guess_key=obtain_subkey_use_L5(plain,cipher)
...
for num_pair in NUM_pair:
    ...
    for i in range(num): 
        ...
        real_key,guess_key=attack_5_round_use_L5(num_pair)
